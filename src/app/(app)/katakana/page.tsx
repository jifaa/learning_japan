...
import { CheckCircle2, Lock, Circle, ArrowRight, BookOpen, Target, ChevronRight } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <FadeIn delay={0.15}>
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            {currentQuiz && (
              <Link href={`/katakana/quiz?quiz=${currentQuiz.id}`}>
      ...
      <FadeIn delay={0.15}>
        <div className="flex flex-col gap-3 sm:flex-row">
          <Link href="/hiragana" className="flex-1">
