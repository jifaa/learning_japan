              ...
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-background border border-border">
                    <span className="text-lg font-medium">あ</span>
                  </div>
                  <div className="min-w-0">
                    <p className="text-sm font-medium">Romaji Keyboard</p>
                    <p className="mt-0.5 text-xs text-muted-foreground">
                      Ketik romaji untuk menghasilkan Hiragana. a → あ, ka → か, ki → き
                    </p>
                  </div>
                </div>
              </CardContent>
