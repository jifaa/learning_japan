...
export default async function HiraganaPage() {
  ...
  const chartData = masteryStats.categories.map((cat) => {
    ...
    for (const c of catChars) {
      ...
      rowMap[row].chars.push({ character: c.kana, romaji: c.romaji, href: `/hiragana/${encodeURIComponent(c.kana)}` });
    }
    return {
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3 items-start">
        ...
        <div className="space-y-6 lg:col-span-2">
                ...
                <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                  {nextCategory ? (
                    ...
                    <p className="text-sm font-medium text-primary">
                      Semua Hiragana dikuasai!
                    </p>
                  ) : null}
                  <Link href="/hiragana/quiz" className="shrink-0">
                    <Button size="sm">
          ...
          <FadeIn delay={0.1}>
            <KanaChartWithLock categories={chartData} script="hiragana" />
          </FadeIn>
          ...
          <FadeIn delay={0.3}>
            <Card className="border-border bg-muted/30">
              <CardContent className="flex items-start gap-3 p-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Klik karakter untuk dengar pengucapan. Ketik romaji: <span className="font-mono text-xs">a</span> → あ, <span className="font-mono text-xs">ka</span> → か. Jawab 3x benar di quiz untuk kuasai.
                </p>
              </CardContent>
            </Card>
          </FadeIn>
          ...
          <FadeIn delay={0.08}>
            <Card className="border-border">
              ...
              <CardContent className="space-y-3">
                <p className="text-sm text-muted-foreground">
                  Uji kemampuan membaca Hiragana dengan quiz singkat.
                </p>
                ...
                <Link href="/hiragana/quiz" className="block">
            ...
            <Card className="border-border">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Link href="/katakana" className="block">
