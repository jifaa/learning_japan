...
export default async function HiraganaQuizPage({ searchParams }: PageProps) {
      ...
      <div className="space-y-8">
        ...
        <FadeIn>
          <div>
            ...
            <h1 className="text-3xl font-semibold tracking-tight">Quiz Hiragana</h1>
              ...
              return (
                ...
                >
                  <CardContent className="p-0">
                    <Link
                      href={isLocked ? "#" : `/hiragana/quiz?quiz=${quiz.id}`}
                      className={cn(
